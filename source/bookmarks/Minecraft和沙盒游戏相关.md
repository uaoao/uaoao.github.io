...
- [ferrumc-rs/ferrumc: A reimplementation of the minecraft server in rust.](https://github.com/ferrumc-rs/ferrumc)
- [Luanti | Open source voxel game engine - Luanti](https://www.luanti.org/en/)
    - [Welcome - ContentDB](https://content.luanti.org/)
- [Terasology](https://terasology.org/)
- [我的世界，但是太空版_单机游戏热门视频](https://www.bilibili.com/video/BV1fY4y1V7Wm/)

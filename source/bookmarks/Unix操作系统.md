...
- [Debian Linux](https://www.debian.org/)
    ...
    - [Debian中文论坛 - Debian中文用户的网上聚居地](https://forums.debiancn.org/)
...
- [KaOS – A Lean KDE Distribution](https://kaosx.us/)
- [Minix3](https://www.minix3.org/)
- [hello — helloSystem documentation](https://hellosystem.github.io/docs/index.html)
